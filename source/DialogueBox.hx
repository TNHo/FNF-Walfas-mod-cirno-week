...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if (PlayState.SONG.song.toLowerCase()=='voile-the-magic-library' || PlayState.SONG.song.toLowerCase()=='centennial-festival')
		{
			portraitLeft = new FlxSprite(-20, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/patchouliPortrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'Senpai Portrait Enter', 24, false);
			portraitLeft.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.9));
			portraitLeft.updateHitbox();
			portraitLeft.scrollFactor.set();
		...
		else if (PlayState.SONG.song.toLowerCase()=='locked-girl')
		{
			portraitLeft = new FlxSprite(-20, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/angrypatchouliPortrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'Senpai Portrait Enter', 24, false);
			portraitLeft.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.9));
			portraitLeft.updateHitbox();
			portraitLeft.scrollFactor.set();
		...
		else if (PlayState.SONG.song.toLowerCase()=='cirno-perfect-math-class')
		{
		...
		else if (PlayState.SONG.song.toLowerCase()=='beloved-tomboyish-girl')
		{
			portraitLeft = new FlxSprite(-50, 40);
		...
		else if (PlayState.SONG.song.toLowerCase()=='rumia')
		{
			portraitLeft = new FlxSprite(-50, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/rumiaPortrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'Dad Portrait Enter', 24, false);
			portraitLeft.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.15));
			portraitLeft.updateHitbox();
			portraitLeft.scrollFactor.set();
		...
		else if (PlayState.SONG.song.toLowerCase()=='chinese-tea')
		{
			portraitLeft = new FlxSprite(-50, 40);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/meilingPortrait', 'shared');
			portraitLeft.animation.addByPrefix('enter', 'Dad Portrait Enter', 24, false);
			portraitLeft.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.15));
			portraitLeft.updateHitbox();
			portraitLeft.scrollFactor.set();
		...
		if (PlayState.SONG.song.toLowerCase()=='cirno-perfect-math-class' || PlayState.SONG.song.toLowerCase()=='beloved-tomboyish-girl')
			...
			portraitLeftcirno.animation.addByPrefix('enter', 'Dad Portrait Enter', 24, false);
			portraitLeftcirno.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.17));
			portraitLeftcirno.updateHitbox();
			portraitLeftcirno.scrollFactor.set();
		...
		if (FlxG.keys.justPressed.ANY  && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'voile-the-magic-library')
